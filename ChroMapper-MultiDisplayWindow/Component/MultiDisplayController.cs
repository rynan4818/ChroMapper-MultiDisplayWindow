    ...
    public class MultiDisplayController : MonoBehaviour
    {
        ...
        private IEnumerator DelayWindow()
        {
            ...
            if (Display.displays.Length > 3 && activeWindow == 3 && Options.Instance.subWindow1 && Options.Instance.subWindow2 && Options.Instance.subWindow3)
            {
                ...
                {
                    yield return new WaitForSeconds(Options.Instance.multiDislayCreateDelay);
                    WindowController.windowReplace(windowInfos[3].Item2, null, Options.Instance.subDisplay3PosX, Options.Instance.subDisplay3PosY, Options.Instance.subDisplay3Width, Options.Instance.subDisplay3Height, false);
                }
                yield return new WaitForSeconds(Options.Instance.multiDislayCreateDelay);
                activeWindow = 4;
            }
        ...
        {
            if (activeWindow - 1 > activeCameraCount && activeCameraCount == 0)
            {
            ...
            if (activeWindow - 1 > activeCameraCount && activeCameraCount == 1)
            {
            ...
            if (activeWindow - 1 > activeCameraCount && activeCameraCount == 2)
            {
